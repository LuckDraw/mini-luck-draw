...
Component({
  ...
  methods: {
    ...
    imgBindloadByBtn: function imgBindloadByBtn(e) {
    ...
    toPlay: function toPlay(e) {
      ...
      this.data.buttons.forEach(function (btn) {
        ...
        if (!ctx.isPointInPath(e.changedTouches[0].x * _this2.dpr, e.changedTouches[0].y * _this2.dpr)) {
          return;
        }
